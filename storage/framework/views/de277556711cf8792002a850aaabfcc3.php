...
<?php endif; ?>
        ...
        <div class="mt-4 text-center">
            <p class="text-sm text-gray-600 dark:text-gray-400">
                ...
                <a href="<?php echo e(route('register')); ?>" class="underline text-sm text-indigo-600 hover:text-indigo-900">
...
<?php endif; ?>
<?php /**PATH C:\Users\luca-\OneDrive\Documentos\Code\rico\resources\views/auth/login.blade.php ENDPATH**/ ?>