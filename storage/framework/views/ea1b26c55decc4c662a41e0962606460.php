...
<?php endif; ?>
        ...
        <div class="flex items-center justify-end mt-4 gap-6">
            ...
            <a href="<?php echo e(route('login')); ?>" class="text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 underline">
...
<?php endif; ?>
<?php /**PATH C:\Users\luca-\OneDrive\Documentos\Code\rico\resources\views/auth/forgot-password.blade.php ENDPATH**/ ?>